...
const AnalyticsCard = ({ name, amount }: Props) => {
  return (
    <div className="bg-[#f0c733] flex items-center justify-between rounded-2xl h-32 w-96 gap-1 p-4">
      <svg
        viewBox="0 0 24 24"
        fill="none"
      ...
      <div className="flex flex-col flex-none">
        ...
        <p className="text-xl">Rs.{amount}</p>
      </div>
    </div>
  );
};
